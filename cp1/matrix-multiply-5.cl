...
*
* This incarnation uses user-specified matrix dimensions. First input is 
* matrix height (rows), second input is matrix width (columns). 
*) 
...
class Main inherits IO {
  ...
  main() : Object {
    let 
      ...
      j : Int,
      k : Int,
      r : Int <- in_int(),  (* matrix height *)
      c : Int <- in_int(),  (* matrix width  *)
      dot_product : Int, 
